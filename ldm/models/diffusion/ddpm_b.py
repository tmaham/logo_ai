...
class LatentDiffusion(DDPM):
    ...
    def training_step_back(self, batch, batch_idx,optimizer_idx=None):
        ...
        # attempt3 
        # loss1, ld = self.shared_step(batch["base"])
        # loss2 = self.clip_loss(batch)
    ...
    @torch.no_grad()
    def validation_step_back(self, batch, batch_idx):
        return None
    ...
    @torch.no_grad()
    def sample_log(self,cond,batch_size,ddim, ddim_steps,uc=None, **kwargs):

        if ddim:
            ddim_sampler = DDIMSampler(self)
            shape = (self.channels, self.image_size, self.image_size)
            samples, intermediates =ddim_sampler.sample(S=ddim_steps,batch_size=batch_size,
                                                        shape=shape,conditioning=cond,unconditional_guidance_scale=7.5,
    ...
    @torch.no_grad()
    def log_images_backup(self, batch, N=8, n_row=4, sample=True, ddim_steps=50, ddim_eta=1., return_keys=None,
